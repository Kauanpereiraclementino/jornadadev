...
O indice da filial,por que vc consegue vincular com uma empresa e saber de onde esta vindo este dado 

# c. Explique por que o prefixo da tabela é Z (o que esse prefixo significa em termos de convenção do Protheus).
È para os dados adicionados pelo proprio usuario que nao vem por padrao 

# d. Explique por que os campos começam com ZA1_ (ex: ZA1_NOME , ZA1_RACA ) e não apenas com o nome do campo solto.
Porque é o prefixo da tabela e sabemos aonde esta vinculado esses dados 
